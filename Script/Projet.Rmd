...
```{r}
#modele heterogène
reg_heter <- lm(EQI_norm ~ annee + pop:annee + surface:annee + revenu:annee + emploi:annee +
                  hotel:annee + meurtre:annee + education:annee - 1, data = data)

summary(reg_heter)

gr_MCO <- systemfit(EQI_norm ~ . - region - annee, method="OLS", data=data)
